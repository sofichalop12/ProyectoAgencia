...
public class ConsultasViajesView extends JFrame {
    ...
    private JComboBox<EstadoViaje> comboEstado;
    ...
    private void initUI() {
        ...
        comboEstado = new JComboBox<>(EstadoViaje.values());
    ...
    private void buscarPorDestino() {
        ...
        for (Viaje v : lista) {
            ...
            String patente = v.getTransporteAsignado() != null ? v.getTransporteAsignado().getPatente() : "Sin transporte";
    ...
    private void buscarPorEstado() {
        resultados.setText("");
        EstadoViaje e = (EstadoViaje) comboEstado.getSelectedItem();
        if (e == null) return;
