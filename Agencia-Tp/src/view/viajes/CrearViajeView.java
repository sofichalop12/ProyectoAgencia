...
public class CrearViajeView extends JFrame {
    ...
    public CrearViajeView(ViajeController vc, DestinoController dc) {
        super("Crear Viaje");
    ...
    private void actualizarTransportes() {
        try {
            ...
            for (Transporte t : transportes) {
                ...
                if (esLargaDistancia && clase.equals("Auto")) continue;
                if (!esLargaDistancia && clase.equals("ColectivoCocheCama")) continue;
