...
public class MainWindow extends JFrame {
    ...
    private void initPanelCentral() {
        ...
        btnCrearViaje.addActionListener(e -> new CrearViajeView(viajeController, destinoController).setVisible(true));
    ...
    private JMenuBar crearMenu() {
        ...
        crearViaje.addActionListener(e -> new CrearViajeView(viajeController, destinoController).setVisible(true));
